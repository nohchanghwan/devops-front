<template>
  <v-navigation-drawer
    ...
    <div class="v-list">
      <a class="v-list-item v-list-item--link grey--text text-sm-h6" target="_blank" >개발</a>
    </div>
...
import {mapActions, mapState} from 'vuex'
  ...
  export default {
    ...
    data(){
      return {
        items: [
          // { title: '메인화면', icon: 'mdi-home', link: '/dashboard' },
          { divider: true },
          { title: 'API 목록조회', icon: 'mdi-animation', link: '/apilist' },
          // { title: 'API 상세 입출력', icon: 'mdi-vector-combine', link: '/apidetails/getChargerInfo' },
          { title: 'API 사용현황 조회', icon: 'mdi-view-module', link: '/Reqcontentsstatus' },
